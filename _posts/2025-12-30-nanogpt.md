---
layout: post
title: "nanoGPT: Let's Reproduce GPT-2 (124M)"
subtitle: ""
date: 2025-12-30
...
- Repo: [shehab-ashraf/nanogpt](https://github.com/shehab-ashraf/GPT-2/tree/main)
- WandB: [ashrafshehab-/nanoGPT](https://wandb.ai/ashrafshehab-/nanoGPT)
- Model: [ashrafs1/nanogpt-3000](https://huggingface.co/ashrafs1/nanogpt-3000) (40.50 PPL)
...
2. **[Making training fast](#making-training-fast)**
...
4. **[Going All In](#going-all-in)**
   - [Model Upgrades](#model-upgrades)
   - [Training Upgrades](#training-upgrades)
   - [3,000 Steps on 2× A100](#3000-steps-on-2x-a100)
...
Muon (Momentum Orthogonalized by Newton–Schulz) is an optimizer designed for the NanoGPT speedrun by Jordan et al. See the [original Muon blog post](https://kellerjordan.github.io/posts/muon/) for the deep mathematical details.
...
Logs: [nanoGPT-1500](https://wandb.ai/ashrafshehab-/nanoGPT/runs/9pyr0ja8?nw=nwuserashrafshehab) · Raw log: [nanogpt-1500.txt](https://github.com/shehab-ashraf/GPT-2/blob/main/records/nanogpt-1500s/nanogpt-1500s.txt) · Model: [ashrafs1/nanogpt-1500s](https://huggingface.co/ashrafs1/nanogpt-1500s)
...
Logs: [nanogpt-3000](https://wandb.ai/ashrafshehab-/nanoGPT/runs/dwa6mxu5?nw=nwuserashrafshehab) · Raw log: [shehab-ashraf/nanoGPT](https://github.com/shehab-ashraf/GPT-2) · Model: [ashrafs1/nanogpt-3000](https://huggingface.co/ashrafs1/nanogpt-3000)
